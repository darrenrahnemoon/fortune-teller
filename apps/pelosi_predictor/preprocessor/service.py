...
from apps.pelosi_predictor.preprocessor.prediction import PelosiPredictorPrediction, PelosiPredictorModelOutput
...
@dataclass
class PelosiPredictorPreprocessorService(PreprocessorService):
	...
	def from_model_output(
		...
		return [
			PelosiPredictorPrediction(
				model_output = PelosiPredictorModelOutput(
