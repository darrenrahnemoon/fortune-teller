...
from apps.magic_crystal.preprocessor.prediction import MagicCrystalPrediction, MagicCrystalModelOutput
...
@dataclass
class MagicCrystalPreprocessorService(PreprocessorService):
	...
	def from_model_output(
		...
		return [
			MagicCrystalPrediction(
				model_output = MagicCrystalModelOutput(
