...
@dataclass
class MagicCrystalModelOutput:
	direction: int = None
	max_high_change: float = None
	min_low_change: float = None

@dataclass
class MagicCrystalPrediction:
	strategy_config: MagicCrystalStrategyConfig = field(repr = False)

	# Raw output
	model_output: MagicCrystalModelOutput = None
